...
• Where were you born (city/state)?`;
  ...
  const copyScript = async () => {
    ...
    } else if (node?.type === 'no-assistance') {
              ...
              if (node.isSolution) {
                return (
                  <div className="space-y-6">
                    ...
                    {(node.type === 'urgent' || node.type === 'regular') && (
                      <>
                        <div className="border border-border bg-card rounded-xl p-6">
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              <h3 className="mb-1">Assistance Confirmation Script</h3>
                              <p className="text-sm text-muted-foreground">
                                Use this script to inform the voter that VoteRiders can help
                              </p>
                            </div>
                            <button
                              onClick={copyScript}
                          ...
                          <div className="bg-muted rounded-lg p-4 border border-border">
                            <p className="leading-relaxed">{assistanceScript}</p>
                          </div>
                        </div>
                        ...
                        {showInfoCollection && (
                          <div className="border border-border bg-card rounded-xl p-6">
                            <div className="flex items-start justify-between mb-4">
                              <div>
                                <h3 className="mb-1">Information Collection Scripts</h3>
                                <p className="text-sm text-muted-foreground">
                                  Use these scripts to collect voter information
                                </p>
                              </div>
                              ...
                              <div className="space-y-4">
                                <div>
                                  <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <p className="text-sm text-muted-foreground italic">First text message</p>
                                  </div>
                                  <div className="bg-muted rounded-lg p-4 border border-border ml-7">
                                    <p className="leading-relaxed whitespace-pre-line">{textCollectionScript1}</p>
                                  </div>
                                </div>
                                ...
                                <div>
                                  <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <p className="text-sm text-muted-foreground italic">After they respond to first message</p>
                                  </div>
                                  <div className="bg-muted rounded-lg p-4 border border-border ml-7">
                                    <p className="leading-relaxed whitespace-pre-line">{textCollectionScript2}</p>
                                  </div>
                                </div>
                                ...
                                <div>
                                  <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <p className="text-sm text-muted-foreground italic">Final text message</p>
                                  </div>
                                  <div className="bg-muted rounded-lg p-4 border border-border ml-7">
                                    <p className="leading-relaxed whitespace-pre-line">{textCollectionScript3}</p>
                                  </div>
                                </div>
                              </div>
                            )}
        ...
        <>
          ...
          {(() => {
            ...
            return (
              <button
                onClick={onContinue}
                className="fixed bottom-8 right-8 flex items-center gap-2 px-6 py-3 rounded-lg text-white shadow-2xl transition-all hover:shadow-xl hover:scale-105 z-50 animate-in fade-in slide-in-from-bottom-4 duration-500"
                style={{ backgroundColor: '#1AC166' }}
              >
                <span className="font-medium">Continue to Step 3</span>
