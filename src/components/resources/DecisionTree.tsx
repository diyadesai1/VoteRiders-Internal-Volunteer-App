        ...
        <>
          ...
          <div className="mb-6 flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-lg text-sm transition-all hover:shadow-lg hover:scale-[1.02] font-medium flex items-center gap-2"
              style={{ 
            ...
            >
              ...
              Information Collection Scripts (Email/Text)
            </button>
          </div>
