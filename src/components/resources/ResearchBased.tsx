...
export function ResearchBased({ context, onBack }: ResearchBasedProps) {
      ...
      {selectedQuestion != null && filteredFAQs[selectedQuestion] && (
        ...
        >
          <div className="w-full max-w-4xl">
            <div
              className="relative rounded-2xl shadow-2xl p-8 max-h-[80vh] overflow-y-auto"
            ...
            >
              <button
                ...
                onClick={() => setSelectedQuestion(null)}
                aria-label="Close"
                className="absolute top-4 right-4 p-2 rounded-lg text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors"
              >
                <X className="size-5" />
              </button>
              ...
              <div className="flex items-start gap-4 pr-10">
                <div
                  ...
                  style={{ backgroundColor: '#1AC166' }}
                >
                  <span className="text-lg font-semibold">{selectedQuestion + 1}</span>
                </div>
                <div className="flex-1">
                  <h2 className="mb-4 text-xl font-semibold leading-relaxed text-gray-900">
                    {filteredFAQs[selectedQuestion].question}
                  </h2>
                  <div className="text-base leading-relaxed mb-6 text-gray-800">
